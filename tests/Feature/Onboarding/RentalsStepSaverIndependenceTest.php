 ...
 * later, rental-work-orders' settings) cannot repeat the saver-precondition
...
final class RentalsStepSaverIndependenceTest extends TestCase
{
    ...
    public function test_saving_the_combined_rentals_step_persists_all_three_fields(): void
    {
    ...
    public function test_saving_the_dedicated_rental_inspection_settings_page_never_touches_lease_settings(): void
    {
        $agency = Agency::create(['name' => 'Coastal Realty', 'slug' => 'coastal-realty-' . uniqid()]);
        $admin = $this->admin($agency);
