...
final class RealTemplate111EndToEndTest extends TestCase
{
    ...
    // AT-373 inc7 — test_flag_blocks_signing_renders_locked_cta_when_recipient_has_pending_flag
    // was removed with the recipient clause-flag freeze UI it pinned (retired this increment;
    // recipients now amend via the wet-ink tool at their turn).
