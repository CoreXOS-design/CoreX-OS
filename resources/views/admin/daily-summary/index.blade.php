...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    ...
    <div class="flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-slate-900">Daily Activity Summary (Company)</h1>
    ...
    <div class="rounded-2xl border bg-white shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b bg-slate-50/60">
            ...
            <div class="text-xs text-slate-500">Click activity name or count to drill down to branches.</div>
        </div>
