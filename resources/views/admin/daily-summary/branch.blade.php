...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    ...
    <div class="flex items-start justify-between gap-4">
        <div>
            <div class="text-sm text-slate-500 space-x-2">
                ...
                <span>›</span>
                <span class="text-slate-700">{{ $branchName }}</span>
            </div>
            <h1 class="text-2xl font-semibold text-slate-900 mt-1">{{ $branchName }} — {{ $def->name }}</h1>
    ...
    <div class="rounded-2xl border bg-white shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b bg-slate-50/60">
            ...
            <div class="text-xs text-slate-500">Click agent name or count to see dates performed.</div>
        </div>
