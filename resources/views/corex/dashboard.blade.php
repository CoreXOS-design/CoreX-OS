...
<div class="space-y-6">
    ...
    {{-- Welcome header --}}
    <div>
        <h1 class="text-2xl font-bold" style="color:var(--brand-primary,#0b2a4a);">
    ...
    <div class="corex-panel max-w-md">
        ...
        <div class="corex-panel-body space-y-4">
            ...
            <div class="flex items-end gap-3">
                <span class="text-5xl font-bold" style="color:var(--brand-primary,#0b2a4a);">
                ...
                <div>
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                        <div class="h-2.5 rounded-full transition-all"
                             style="width:{{ $pct }}%; background:var(--brand-secondary,#00b4d8);"></div>
                    </div>
                </div>
            @else
