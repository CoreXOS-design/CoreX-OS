                    ...
                    <div class="flex-1" style="overflow-y:auto;">
                        <button type="button" @click="pickAgent('')"
                           ...
                           onmouseover="this.style.background='var(--surface-2)'" onmouseout="this.style.background=''">
                            ...
                            All agents
                            <template x-if="!{{ is_numeric($filterAgentId) ? (int) $filterAgentId : 0 }}">
                        ...
                        <template x-for="agent in filtered" :key="agent.id">
                            <button type="button" @click="pickAgent(agent.id)"
                               ...
                               :style="({{ is_numeric($filterAgentId) ? (int) $filterAgentId : 0 }} === agent.id ? 'background:var(--surface-2);' : '')"
                               onmouseover="this.style.background='var(--surface-2)'" :onmouseout="({{ is_numeric($filterAgentId) ? (int) $filterAgentId : 0 }} === agent.id ? `this.style.background='var(--surface-2)'` : `this.style.background=''`)">
                                ...
                                <template x-if="{{ is_numeric($filterAgentId) ? (int) $filterAgentId : 0 }} === agent.id">
