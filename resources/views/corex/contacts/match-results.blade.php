            ...
            <div class="flex flex-col md:items-end gap-3 flex-shrink-0">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    {{-- Print / Download PDF — the resolved list as a clean A4 sheet for
                         appointment rounds. INTERNAL (seller + address details); opens
                         inline so the browser print dialog is one click away. --}}
                    <a href="{{ route('corex.contacts.matches.print', [$contact, $match]) }}" target="_blank" rel="noopener noreferrer"
