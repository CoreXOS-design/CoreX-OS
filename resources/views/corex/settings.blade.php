    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div style="background:#0d1f35; border:1px solid rgba(255,255,255,0.07); border-radius:16px; padding:20px 24px;">
            ...
            <div style="display:flex; flex-direction:column; gap:4px;">
                ...
                <a href="{{ route('corex.role-manager') }}" style="display:flex; align-items:center; gap:12px; padding:10px 12px; border-radius:10px; text-decoration:none; transition:background 0.12s;" onmouseover="this.style.background='rgba(255,255,255,0.05)'" onmouseout="this.style.background='transparent'">
