    ...
    <div class="rounded-md px-6 py-5 corex-page-banner mb-5">
        <div class="flex items-start justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route(session('corex.lens.properties_imported', false) ? 'corex.properties.imported-stock' : (session('corex.lens.properties', false) ? 'corex.rentals.properties.index' : 'corex.properties.index')) }}"
                   class="text-xs font-medium px-3 py-1.5 rounded-md transition-all duration-300"
                   style="background:rgba(255,255,255,0.1);color:#fff;border:1px solid rgba(255,255,255,0.15);">
