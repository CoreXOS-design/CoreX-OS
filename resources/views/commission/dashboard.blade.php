...
<div class="w-full space-y-5">
    ...
    <div class="rounded-md px-6 py-5 corex-page-banner">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div data-tour="earn-dashboard-intro">
                ...
                <p class="text-xs" style="color: var(--text-muted);">Commission, cap progress, and revenue share at a glance.</p>
            </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" data-tour="earn-dashboard-cards">
        ...
        <div class="rounded-md px-5 py-4" style="background:var(--surface); border:1px solid var(--border);">
            ...
            <div class="text-[1.625rem] font-bold leading-tight tabular-nums" style="color:var(--text-primary);">R {{ number_format($thisMonthGCI, 2) }}</div>
        ...
        <div class="rounded-md px-5 py-4" style="background:var(--surface); border:1px solid var(--border);">
            ...
            <div class="text-[1.625rem] font-bold leading-tight tabular-nums" style="color:var(--text-primary);">R {{ number_format($thisYearGCI, 2) }}</div>
            <div class="text-xs mt-1" style="color:var(--text-secondary);">Net agent earnings</div>
        </div>
        ...
        <div class="rounded-md px-5 py-4" style="background:var(--surface); border:1px solid var(--border);">
            ...
            <div class="text-[1.625rem] font-bold leading-tight tabular-nums" style="color:var(--text-primary);">
            ...
            <div class="mt-2 h-2 rounded-full overflow-hidden" style="background:var(--border);">
                <div class="h-full rounded-full transition-all duration-500"
                     style="width:{{ $capPercent }}%; background:{{ $capPeriod->is_capped ? 'var(--ds-amber,#f59e0b)' : 'var(--brand-button)' }};"></div>
            </div>
        ...
        <div class="rounded-md px-5 py-4" style="background:var(--surface); border:1px solid var(--border);">
            ...
            <div class="text-[1.625rem] font-bold leading-tight tabular-nums" style="color:var(--ds-teal, #14b8a6);">R {{ number_format($thisMonthRevShare, 2) }}</div>
    ...
    <div class="rounded-md px-6 py-5" style="background:var(--surface); border:1px solid var(--border);" data-tour="earn-dashboard-cap">
        ...
        <div class="h-3 rounded-full overflow-hidden" style="background:var(--border);">
            <div class="h-full rounded-full transition-all duration-700 relative"
                 style="width:{{ $capPercent }}%; background:{{ $capPeriod->is_capped ? 'var(--ds-amber,#f59e0b)' : 'var(--brand-button)' }};">
            </div>
        </div>

        <div class="flex items-center justify-between mt-2">
            <div class="text-xs font-medium tabular-nums" style="color:var(--text-secondary);">R {{ number_format($capProgress, 2) }} paid</div>
            <div class="text-xs font-medium tabular-nums" style="color:var(--text-secondary);">R {{ number_format($capTotal, 2) }} cap</div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div class="rounded-md px-6 py-5" style="background:var(--surface); border:1px solid var(--border);">
            ...
            <div class="space-y-3">
                <div class="flex items-center justify-between p-3 rounded-md" style="background:var(--surface-2); border:1px solid var(--border);">
                    <div>
                        <div class="text-xs font-semibold uppercase tracking-wider" style="color:var(--text-muted);">Tier 1 Agents</div>
                        <div class="text-lg font-bold tabular-nums" style="color:var(--text-primary);">{{ $tier1Agents->count() }}</div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8" style="color:var(--text-faint);">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="p-3 rounded-md" style="background:var(--surface-2); border:1px solid var(--border);">
                        ...
                        <div class="text-lg font-bold tabular-nums" style="color:var(--ds-teal, #14b8a6);">R {{ number_format($thisMonthRevShare, 2) }}</div>
                    </div>
                    <div class="p-3 rounded-md" style="background:var(--surface-2); border:1px solid var(--border);">
                        <div class="text-xs" style="color:var(--text-muted);">Rev Share This Year</div>
                        <div class="text-lg font-bold tabular-nums" style="color:var(--ds-teal, #14b8a6);">R {{ number_format($thisYearRevShare, 2) }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            @else
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-2.5 rounded-md transition-colors"
                        ...
                        <div class="text-sm font-semibold tabular-nums" style="color:var(--text-secondary);">
