...
<div class="w-full space-y-5" x-data="buyerWishlists(@js($wishlistsConfig))">
    ...
    {{-- ════════════════════════════════════════════════════════════════════
         ...
         corex-page-banner. The old layout put "Back to Buyer Pipeline" on
        ...
        <div class="px-5 py-3.5 flex flex-wrap items-center justify-between gap-x-4 gap-y-3">
            <div class="flex flex-wrap items-center gap-x-3 gap-y-2 min-w-0">
                <a href="{{ route('command-center.buyers.pipeline') }}"
                   ...
                   title="Back to Buyer Pipeline" aria-label="Back to Buyer Pipeline">
                    ...
                    <span class="sr-only">Back to Buyer Pipeline</span>
                </a>
