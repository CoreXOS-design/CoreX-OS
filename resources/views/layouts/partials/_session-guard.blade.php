{{--
    ...
    guard asset (public/js/corex-connection-guard.js — plain asset, no Vite build)
    ...
    (they just register an extra token sink). See public/js/corex-connection-guard.js.
--}}
@auth
<script src="{{ asset('js/corex-connection-guard.js') }}"></script>
<script>
(function () {
    if (!window.CoreXConnectionGuard) return;
    ...
    window.CoreXConnectionGuard.startHeartbeat(function (token) {
