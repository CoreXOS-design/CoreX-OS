...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    {{-- F.2: page header / smart filter presets / stats cards / match toggles /
         filter bar / claim filter strip / filtered-to-zero banner all removed.
         The new top bar (F.2) + stats strip (F.2) + filter rail (F.2) replace
         them. The pre-F.2 markup is preserved in resources/views/prospecting/index_legacy_body.blade.php
         and still rendered when the legacy /prospecting URL is hit (rare during
         the F.1 migration window). --}}
