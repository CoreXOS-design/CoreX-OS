<div class="max-w-2xl space-y-5" x-data="{
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            <p class="text-[10px] mt-0.5" style="color:var(--text-secondary, #94a3b8);">Internal reference — lowercase, hyphens, underscores. e.g. 'loan_repayment'.</p>
    ...
    <div class="p-4" style="background:var(--surface-2, #f8fafc); border:1px solid var(--border, #e5e7eb); border-radius:3px;">
        <h4 class="text-xs font-bold uppercase mb-3" style="color:var(--text-secondary, #94a3b8); letter-spacing:0.05em; font-family:'Plus Jakarta Sans',sans-serif;">Classification</h4>
        <label class="relative inline-flex items-center cursor-pointer gap-3">
            ...
            <div>
                ...
                <p class="text-[10px]" style="color:var(--text-secondary, #94a3b8);">PAYE, UIF — amounts auto-calculated by the payroll engine</p>
                @if(isset($locked) && ($locked['statutory'] ?? false))
                    <p class="text-[10px]" style="color:var(--text-secondary, #94a3b8);">Locked — statutory flag cannot be changed</p>
                @endif
            </div>
        </label>
    </div>
    ...
    <div class="flex items-center gap-3 pt-2">
        ...
        <a href="{{ route('payroll.deduction-types.index') }}" class="px-4 py-2 text-sm font-semibold transition" style="color:var(--text-secondary, #6b7280); border:1px solid var(--border, #e5e7eb); border-radius:3px;">Cancel</a>
    </div>
</div>
