...
<div class="space-y-5">
    ...
    <div class="rounded-md px-6 py-5 corex-page-banner">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div>
                <h1 class="text-base font-bold leading-tight" style="color: var(--text-primary);">Image to PDF</h1>
                <p class="text-xs" style="color: var(--text-muted);">Turn JPG, PNG or HEIC photos into a clean PDF.</p>
            </div>
        </div>
    </div>
