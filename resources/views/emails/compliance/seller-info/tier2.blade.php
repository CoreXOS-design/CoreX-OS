...
<head>
    ...
    <title>Why an FFC Matters When Choosing an Agent</title>
    <style>
...
<div class="header">
    <h1>Why an FFC Matters When Choosing an Agent</h1>
...
<p>Before signing ANY paperwork with a property practitioner, verify these THREE things:</p>
...
<p>Section 47 of the Property Practitioners Act requires every property practitioner to be registered with the PPRA. This includes:</p>
<ul>
    <li>Estate agents</li>
    <li>Auctioneers</li>
    <li>Property managers</li>
    <li>Bond originators (in some cases)</li>
    <li>Homeowners associations</li>
    <li>Property developers</li>
</ul>
<p>If their name does not appear on the PPRA register, they may be operating illegally. Section 49 of the Act makes operating as a property practitioner without an FFC a criminal offence &mdash; punishable by fine or imprisonment up to 10 years.</p>
...
<div class="callout-danger callout">
    <h4>What to Do If Something Seems Wrong</h4>
    <ul>
...
{{-- ═══════════ Brief BLOCK A mention ═══════════ --}}
<h2>What Proper Paperwork Protects You From</h2>

<p>When you work with a properly registered agent, they are required to put three documents in place: a written <strong>mandate</strong>, <strong>FICA verification</strong>, and a <strong>Mandatory Disclosure Form</strong>. These cost you nothing and protect you from double commission claims, buyer disputes, and post-sale defect claims that can run into hundreds of thousands of rands.</p>
