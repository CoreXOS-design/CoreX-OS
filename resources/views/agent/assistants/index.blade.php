...
<div class="w-full max-w-4xl space-y-5">
    ...
    @foreach($assignments as $row)
        ...
        <div class="rounded-md p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4"
            ...
            <a href="{{ route('agent.assistants.matrix', $a) }}" class="corex-btn-primary">
