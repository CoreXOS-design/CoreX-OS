...
<div class="w-full space-y-5">
    ...
    <div class="rounded-md px-6 py-5 corex-page-banner">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div>
                <h1 class="text-base font-bold leading-tight" style="color: var(--text-primary);">Agent Compliance Dashboard</h1>
                <p class="text-xs" style="color: var(--text-muted);">FFC, training, and compliance status for all agents.</p>
            </div>
        </div>
    </div>
                    ...
                    <tr class="transition-colors" style="border-top: 1px solid var(--border);">
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="ds-badge" style="background: color-mix(in srgb, var(--brand-icon, #0ea5e9) 12%, transparent); color: var(--brand-icon, #0ea5e9);">
