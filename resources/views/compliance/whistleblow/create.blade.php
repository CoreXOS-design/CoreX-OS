...
<div class="w-full space-y-4">
    ...
    <div class="rounded-md px-6 py-5 corex-page-banner">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div>
                <h1 class="text-base font-bold leading-tight" style="color: var(--text-primary);">File a Compliance Report</h1>
                <p class="text-xs" style="color: var(--text-muted);">Report one or more agencies/practitioners marketing a property without proper compliance documentation.</p>
            </div>
