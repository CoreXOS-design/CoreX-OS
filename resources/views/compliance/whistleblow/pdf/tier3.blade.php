...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .severity-badge { position: absolute; top: 20mm; right: 0; background: #7c2d12; color: #fff; font-size: 10pt; font-weight: 700; padding: 6pt 14pt; border-radius: 3px; letter-spacing: 1pt; }
        ...
        .tier-subtitle { text-align: center; margin-top: 10mm; font-size: 11pt; color: #7c2d12; font-weight: 600; padding: 8pt 16pt; border: 2px solid #7c2d12; border-radius: 3px; display: inline-block; }
        ...
        .legal-cite h4 { color: #991b1b; font-size: 10pt; margin-bottom: 4pt; }
        .legal-cite ul { margin-left: 16pt; font-size: 9.5pt; color: #374151; }
        .legal-cite li { margin-bottom: 3pt; }

        .criminal-warning { background: #7c2d12; color: #fff; border-radius: 3px; padding: 10pt 14pt; margin: 10pt 0; font-size: 10pt; font-weight: 600; }
...
{{-- ═══════════ COVER PAGE ═══════════ --}}
<div class="cover">
    <div class="severity-badge">HIGHEST</div>
    ...
    <div class="cover-meta">
        ...
        <div class="cover-meta-row">
            ...
            <span class="cover-meta-value">Tier 3</span>
        </div>
    </div>

    <div class="tier-subtitle-wrap">
        <span class="tier-subtitle">Tier 3 — Unregistered Practitioner (Criminal Offence)</span>
    </div>
</div>
...
{{-- ═══════════ SECTION 3: TIER 3 NARRATIVE ═══════════ --}}
<div class="section">
    <h3 class="section-title">3. Complaint Narrative</h3>

    <div class="criminal-warning">
        NOTE: This complaint relates to a potential criminal offence under Section 49 of the Property Practitioners Act 22 of 2019 — operating as a property practitioner without a valid Fidelity Fund Certificate.
    </div>

    <div class="narrative">
        On {{ $complaint->created_at->format('d F Y') }}, the lodging agency identified an advertisement for the subject property by an individual / entity whose registration could not be verified against the PPRA "Find a Property Practitioner" register. A search of the register returned no matching results for the subject practitioner or agency.
    </div>
    ...
    <div class="legal-cite">
        ...
        <ul>
            <li><strong>Section 49</strong> — Operating Without FFC (Criminal Offence): No person may perform any act as a property practitioner, or hold themselves out as such, unless they are in possession of a valid fidelity fund certificate issued by the Authority. Contravention of this section constitutes a criminal offence.</li>
        </ul>
    </div>
</div>
