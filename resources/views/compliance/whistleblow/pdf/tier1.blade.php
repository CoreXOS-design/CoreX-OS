...
<div class="section">
    ...
    <div class="seller-box">
        ...
        @if($complaint->seller_consents_to_named_complaint && $complaint->sellerContact)
        <p style="font-size: 9.5pt; color: #64748b; margin-bottom: 6pt;">
            Seller: {{ $complaint->sellerContact->first_name }} {{ $complaint->sellerContact->last_name }}
            (consents to be named in this complaint)
        </p>
        @elseif($complaint->seller_consents_to_named_complaint)
        <p style="font-size: 9.5pt; color: #64748b; margin-bottom: 6pt;">
            Seller consents to be named in this complaint.
        </p>
        @endif
