...
<div class="-m-4 lg:-m-6">
    <x-page-header title="Acknowledgement Receipt" :back-route="route('agent.portal')" back-label="My Portal" :flush="true">
        <x-slot:actions>
            <a href="{{ route('rmcp.ack.receipt.pdf', $ack) }}" class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-semibold transition" style="border:1px solid var(--border, #e5e7eb); border-radius:6px; color:var(--text-secondary, #6b7280);">
