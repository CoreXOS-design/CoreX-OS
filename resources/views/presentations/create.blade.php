...
<div class="max-w-3xl mx-auto">
    ...
    {{-- Navy header bar --}}
    <div style="background:#0f172a;" class="rounded-2xl px-6 py-4 mb-6">
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" required
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-[#00d4aa] focus:ring-1 focus:ring-[#00d4aa] outline-none"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="property_type" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-[#00d4aa] focus:ring-1 focus:ring-[#00d4aa] outline-none">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="asking_price_inc" value="{{ old('asking_price_inc') }}" required
                           min="0" step="1"
                           class="w-full border border-gray-300 rounded-lg pl-8 pr-3 py-2 text-sm focus:border-[#00d4aa] focus:ring-1 focus:ring-[#00d4aa] outline-none"
            ...
            <div>
                ...
                @else
                    <select name="branch_id" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-[#00d4aa] focus:ring-1 focus:ring-[#00d4aa] outline-none">
