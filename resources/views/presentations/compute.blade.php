...
<div class="ds-status-card mb-6" style="border-left-color: var(--ds-cyan);">
    <h2 class="ds-section-header mb-3">Inputs</h2>
...
<div class="ds-status-card mb-6" style="border-left-color: var(--ds-cyan);">
    <h2 class="ds-section-header mb-1">What's Driving This</h2>
    <p class="ds-section-sub mb-4">Top 3 signals by influence on the probability score.</p>
...
<div class="ds-status-card mb-6" style="border-left-color: var(--ds-cyan);">
    <h2 class="ds-section-header mb-1">Price Sensitivity</h2>
    <p class="ds-section-sub mb-4">Effect of a price reduction on 60-day probability and expected sale time.</p>
