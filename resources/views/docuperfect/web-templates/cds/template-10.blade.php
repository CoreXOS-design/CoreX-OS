...
<div class="corex-clause corex-clause-indent-1"><span class="corex-clause-text">The Seller shall pay the Agency the professional fee stated above, plus VAT where applicable, of the price at which the property is sold. The professional fee is payable on registration of transfer.</span></div>
<div class="corex-clause corex-clause-indent-1"><span class="corex-clause-text">The Seller consents to the Agency placing a "For Sale" board on the property.</span></div>
<div class="corex-h1">FICA AND POPIA</div>
<div class="corex-clause corex-clause-indent-1"><span class="corex-clause-text">Before marketing begins, the Seller will complete the Mandatory Disclosure Form and provide the FICA documents required to verify the Seller’s identity. the Agency will handle the Seller’s personal information in line with the Protection of Personal Information Act (POPIA).</span></div>
