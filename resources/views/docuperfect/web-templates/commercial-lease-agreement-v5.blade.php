...
<div class="page">
    ...
    <div class="clause">
        <p>1.1 <span class="field" data-field="lessor_name">{{ $lessor_name ?? '' }}</span> (Lessor)<br>
            <span class="field" data-field="lessor_name_2">{{ $lessor_name_2 ?? '' }}</span><br>
        ...
        <p>1.2 <span class="field" data-field="lessee_name">{{ $lessee_name ?? '' }}</span> (Lessee)<br>
            <span class="field" data-field="lessee_name_2">{{ $lessee_name_2 ?? '' }}</span><br>
...
<div class="page page-break">
    ...
    <div class="clause">
        ...
        <div class="sub-clause">3.2 The Premises shall be used for the Sole purpose of business. The Lessee
            ...
            <span class="field field-wide" data-field="business_type">{{ $business_type ?? '' }}</span></div>
    </div>
    ...
    <div class="clause">
        ...
        <div class="sub-clause">4.2 The Rental shall be subject to an escalation of <span class="field field-short" data-field="escalation_percent">{{ $escalation_percent ?? '' }}</span>%
            (<span class="field field-medium" data-field="escalation_in_words">{{ $escalation_in_words ?? '' }}</span>)
            per annum from the 1st day of <span class="field field-medium" data-field="escalation_month">{{ $escalation_month ?? '' }}</span> each year,
    ...
    <div class="clause">
        <div class="sub-clause">5.1 The lease shall commence on <span class="field field-medium" data-field="lease_start">{{ $lease_start ?? '' }}</span>, and shall
            ...
            termination &mdash;
            <div class="sub-sub-clause">5.1.1 may not be given by either party to expire prior to the <span class="field field-short" data-field="min_term_day">{{ $min_term_day ?? '' }}</span>
                day of <span class="field field-medium" data-field="min_term_month">{{ $min_term_month ?? '' }}</span> in the year <span class="field field-short" data-field="min_term_year">{{ $min_term_year ?? '' }}</span>; and</div>
        ...
        <div class="sub-clause">5.2 The lease shall expire at midnight on <span class="field field-medium" data-field="lease_end">{{ $lease_end ?? '' }}</span>, (the
            ...
            the option to renew the lease for a further period of <span class="field field-short" data-field="renewal_months">{{ $renewal_months ?? '' }}</span> months
    ...
    <div class="clause">
        <div class="sub-clause">6.1 The Lessee shall within 48 HRS, after the Lessor has signed this
            ...
            deposit of <span class="field field-medium" data-field="electricity_deposit">{{ $electricity_deposit ?? '' }}</span> to the Estate Agent to be kept by him
...
<div class="page page-break">
    ...
    <table class="financial-table">
        ...
        <tr>
            ...
            <td><span class="field" data-field="agent_commission" style="min-width:auto;width:100%;border-bottom:none;">{{ $agent_commission ?? '' }}</span></td>
        </tr>
        <tr>
    ...
    <div class="signature-section">
        ...
        <div class="signature-grid" style="grid-template-columns: 1fr 1fr 1fr; margin-top: 8pt;">
            ...
            <div>
                <p>Date: <span class="field field-short" data-field="addendum_lessee_date">{{ $addendum_lessee_date ?? '' }}</span></p>
            </div>
            <div>
