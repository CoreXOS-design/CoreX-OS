...
/**
 * PolicyAcknowledgement (AT-29) — the per-staff signed record. Mirrors
 * RmcpAcknowledgement; bound to a specific policy_version_id. complete()
 * stamps valid_until = +1yr and persists the signature evidence.
 */
class PolicyAcknowledgement extends Model
{
    ...
    {
        return $this->hasMany(PolicySectionAcknowledgement::class, 'policy_acknowledgement_id');
    }
