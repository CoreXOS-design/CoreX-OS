...
class DeliverAgencyWebhook implements ShouldQueue
{
    ...
    {
        // 2026-08-05 incident (Johan, ca906ba4) — this job must NEVER share a
        // lane with long-running background work (RegenerateBuyerMatchesJob et
        // al monopolized the shared `default` queue and delayed website webhook
