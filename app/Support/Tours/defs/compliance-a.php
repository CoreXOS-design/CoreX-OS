 ...
 *
 * Advanced Guide note: where a button LEAVES the page (New Screening, View,
 * Review), the explanation step stays a read step and the matching "do" step
    ...
    'comp-fica-create' => [
        ...
        'steps' => [
            ...
            [
                ...
                'do'      => ['action' => 'appear', 'say' => 'Search for the contact and pick them from the list.', 'until' => '[data-tour="comp-fica-create-picked"]'],
            ...
            [
                // Only on screen when the picked contact has no email on file.
                'element' => '[data-tour="comp-fica-create-email"]',
                'advanced_only' => true,
                'do'      => ['action' => 'fill', 'say' => 'Type their email address — the secure link goes there.'],
                'title'   => 'Add an email',
                'body'    => 'This contact has no email on file. What you type is saved to their record, and the verification link is sent to it.',
            ],
            [
                'element' => '[data-tour="comp-fica-create-send"]',
                'section' => 'Sending the request',
                'do'      => ['action' => 'click', 'say' => 'Click Send FICA Request — this emails the contact a secure link to upload their documents.'],
    ...
    'comp-screenings' => [
        ...
        'steps' => [
            ...
            [
                ...
                'do'      => ['action' => 'fill', 'target' => 'input[name="search"]', 'say' => 'Type a staff member\'s name, then press Enter.'],
            ...
            [
                'element' => '[data-tour="comp-screenings-filters"]',
                'advanced_only' => true,
                'do'      => ['action' => 'choose', 'say' => 'Pick a status or a risk tier — or press Skip this step.'],
                'title'   => 'Narrow it down',
                'body'    => 'The list updates as soon as you pick. Clear takes you back to everyone.',
            ],
            [
                'element' => '[data-tour="comp-screenings-table"]',
                'section' => 'Opening a screening',
                'do'      => ['action' => 'click', 'target' => 'a', 'say' => 'Click View on a screening to open it — or press Skip this step.'],
            ...
            [
                ...
                'advanced_only' => true,
                'section' => 'Starting a screening',
                'do'      => ['action' => 'click', 'say' => 'Click New Screening to start one for a staff member.'],
                'title'   => 'Start the screening',
                'body'    => 'You pick the staff member and CoreX lays out the checks their role needs, ready for you to work through.',
            ],
        ],
    ],
    ...
    'comp-verification' => [
        ...
        'steps' => [
            [
                ...
                'section' => 'Checking what\'s been done',
            ...
            [
                ...
                'do'      => ['action' => 'choose', 'say' => 'Click Verified or Rejected to see what was actioned this week.'],
            ...
            [
                ...
                'section' => 'Working the queue',
                'do'      => ['action' => 'click', 'target' => 'a', 'say' => 'Click Review on a document to check it.'],
    ...
    'comp-seller-info' => [
        ...
        'steps' => [
            ...
            [
                ...
                'do'      => ['action' => 'choose', 'say' => 'Pick the issue you\'re addressing.'],
            ...
            [
                ...
                'section' => 'Choosing recipients',
                'do'      => ['action' => 'appear', 'say' => 'Search for the property and pick it — or press Skip this step to add people by hand.', 'until' => '[data-tour="comp-seller-info-property-picked"]'],
            ...
            [
                ...
                'do'      => ['action' => 'choose', 'say' => 'Tick who should get it, or click Add Recipient to add someone.'],
            ...
            [
                'element' => '[data-tour="comp-seller-info-recipients"]',
                'advanced_only' => true,
                'do'      => ['action' => 'fill', 'target' => 'input[type="email"]', 'say' => 'Type their name, then their email address — or press Skip this step if everyone\'s listed.'],
                'title'   => 'Add their details',
                'body'    => 'Someone you add by hand needs a name and an email address — that\'s where the pack is sent.',
            ],
            [
                'element' => '[data-tour="comp-seller-info-actions"]',
                'section' => 'Sending the pack',
                'do'      => ['action' => 'click', 'target' => 'button[type="button"]', 'say' => 'Click Preview Email to see exactly what they\'ll get.'],
            ...
            [
                'element' => '[data-tour="comp-seller-info-actions"]',
                'advanced_only' => true,
                'do'      => ['action' => 'click', 'target' => 'button[type="submit"]', 'say' => 'Click Send — this emails the pack to everyone you ticked.'],
                'title'   => 'Send it',
                'body'    => 'Close the preview first. Rather share it on WhatsApp? Use Copy WhatsApp Link instead and paste the link into your chat with the seller.',
            ],
        ],
    ],
