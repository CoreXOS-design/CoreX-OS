...
return [
    ...
    // Property evaluation / search tool (misc-evaluation) retired 2026-09-19 with
    // its page: the Evaluation screen was a sample-data mock-up and is hidden until
    // real reports are specced and built. Re-add a tour with the real screen.
