...
final class MapPinService
{
    ...
    private function trackedProperties(MapBoundsRequest $req, int $limit): array
    {
        ...
        // the same physical property (708 Bournemouth Avenue / tracked_property
        // #10812 vs property #3062 — identical street_number, street_name and
        // suburb on both sides, GPS ~5m apart, "GPS: exact" confidence).
        //
