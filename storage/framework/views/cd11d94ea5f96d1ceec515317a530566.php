        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mt-0.5">
                ...
                <?php if($presentation->property_address): ?>
                    <span class="text-gray-600">&middot;</span> <?php echo e($presentation->property_address); ?>

                <?php endif; ?>
                <?php if($presentation->suburb): ?>
                    <span class="text-gray-600">&middot;</span> <?php echo e($presentation->suburb); ?>
    ...
    <div class="bg-gray-900 border border-gray-800 rounded-2xl p-5">
            ...
            <div class="flex-1 min-w-[200px]">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="inp-price"
                           value="<?php echo e($defaults['price'] ?? ''); ?>"
        ...
        <div class="grid grid-cols-2 gap-3 sm:grid-cols-4 mb-5">
            <div>
                ...
                <input type="text" id="inp-suburb" value="<?php echo e($defaults['suburb']); ?>"
            ...
            <div>
                ...
                <select id="inp-type" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-1.5 text-xs text-gray-200 focus:border-indigo-500 outline-none transition-colors">
                    <?php $__currentLoopData = ['house','unit','land','other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t); ?>" <?php echo e($defaults['type'] === $t ? 'selected' : ''); ?>><?php echo e(ucfirst($t)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                <label class="block text-[10px] uppercase tracking-widest text-gray-500 mb-1">Bedrooms</label>
                <input type="number" id="inp-bedrooms" min="0" max="20" value="<?php echo e($defaults['bedrooms'] ?? ''); ?>"
                       class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-1.5 text-xs text-gray-200 focus:border-indigo-500 outline-none transition-colors">
            </div>
            <div>
                <label class="block text-[10px] uppercase tracking-widest text-gray-500 mb-1">Size m&sup2;</label>
                <input type="number" id="inp-size" min="0" value="<?php echo e($defaults['size_m2'] ?? ''); ?>"
                       class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-1.5 text-xs text-gray-200 focus:border-indigo-500 outline-none transition-colors">
            </div>
        </div>

        
        <input type="hidden" id="inp-period" value="<?php echo e($defaults['period_months'] ?? 12); ?>">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <button id="btn-simulate"
                    ...
                    <?php echo e($canSimulate ? '' : 'disabled'); ?>>
            ...
            <div class="relative group">
                <button id="btn-priceband"
                        ...
                        <?php echo e($canPriceBand ? '' : 'disabled'); ?>>
                    Price Band
                </button>
                <?php if (! ($canPriceBand)): ?>
            ...
            <div class="relative group">
                <button id="btn-threats"
                        class="px-4 py-2 bg-gray-800 border border-gray-700 text-gray-300 text-xs font-medium rounded-lg hover:border-gray-500 hover:text-white transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                        <?php echo e($canThreats ? '' : 'disabled'); ?>>
                    Competitive Threats
                </button>
                <?php if (! ($canThreats)): ?>
            ...
            <div class="relative group">
                <button id="btn-trajectory"
                        class="px-4 py-2 bg-gray-800 border border-gray-700 text-gray-300 text-xs font-medium rounded-lg hover:border-gray-500 hover:text-white transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                        <?php echo e($canTrajectory ? '' : 'disabled'); ?>>
                    Trajectory
                </button>
                <?php if (! ($canTrajectory)): ?>
...
(function () {
    ...
    // ── Feature map ──────────────────────────────────────────────────
    var features = {
        canSimulate:  <?php echo e($canSimulate  ? 'true' : 'false'); ?>,
        canTrajectory: <?php echo e($canTrajectory ? 'true' : 'false'); ?>,
        canPriceBand:  <?php echo e($canPriceBand  ? 'true' : 'false'); ?>,
        canThreats:    <?php echo e($canThreats    ? 'true' : 'false'); ?>,
    };

    var csrf    = '<?php echo e(csrf_token()); ?>';
    var baseUrl = '<?php echo e(url("presentations/" . $presentation->id)); ?>';
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/presentations/brain.blade.php ENDPATH**/ ?>