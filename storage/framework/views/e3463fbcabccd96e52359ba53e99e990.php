...
<div class="bg-white shadow rounded p-5 mb-6 border-l-4 <?php echo e((data_get($companyRequirement, 'shortfall', 0) > 0) ? 'border-red-600' : 'border-green-600'); ?>">
    ...
    <div class="bg-white border rounded p-4 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
                ...
                <div class="font-bold"><?php echo e($rentalsActive); ?></div>
            </div>

            <div>
                <div class="text-gray-500">Rental Assist</div>
                <div class="font-bold"><?php echo e($rentalsAssist); ?></div>
            </div>

            <div>
                <div class="text-gray-500">Commission (Excl VAT)</div>
                <div class="font-bold">R <?php echo e(number_format($rentalsCommExcl, 2)); ?></div>
            </div>
        </div>
...
<?php if(!empty($companyRequirement)): ?>
    <form method="POST" action="<?php echo e(route('worksheet.store')); ?>" class="bg-white shadow rounded p-5 mb-8">
        <?php echo csrf_field(); ?>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div>
                <label class="block text-sm font-medium">Period (YYYY-MM)</label>
                <input type="month" name="period" value="<?php echo e(old('period', $w->period ?? now()->format('Y-m'))); ?>" class="mt-1 w-full border rounded p-2" />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
        <div>
            ...
            <div class="font-bold">R <?php echo e(number_format($companyRequirement['branch_budget'], 2)); ?></div>
              <div class="text-xs text-gray-500">Ex VAT</div>
        </div>

        <div>
            <div class="text-gray-500">Agents in Branch</div>
            <div class="font-bold"><?php echo e($companyRequirement['agents']); ?></div>
        </div>

        <div>
            <div class="text-gray-500">Required per Agent</div>
            <div class="font-bold">R <?php echo e(number_format($companyRequirement['required_per_agent'], 2)); ?></div>
              <div class="text-xs text-gray-500">Ex VAT</div>
        </div>

        <div>
            <div class="text-gray-500">Company Earns from You</div>
            <div class="font-bold">R <?php echo e(number_format($companyRequirement['current_company_income'], 2)); ?></div>
            <div class="text-xs text-gray-500">Ex VAT • if you hit your current budget</div>
        </div>

        <div>
            <div class="text-gray-500">Shortfall</div>
            <div class="font-bold <?php echo e($companyRequirement['shortfall'] > 0 ? 'text-red-600' : 'text-green-600'); ?>">
            ...
            <div class="bg-gray-50 border rounded p-4 mb-4">
                ...
                <div class="flex flex-col md:flex-row gap-3">
                    <button type="submit"
                            ...
                            formmethod="POST"
                            class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm <?php echo e($canApplyBranchDefault ? '' : 'opacity-50 cursor-not-allowed'); ?>"
                    ...
                    <button type="submit"
                            ...
                            formmethod="POST"
                            class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded text-sm <?php echo e($canAlignToCompany ? '' : 'opacity-50 cursor-not-allowed'); ?>"
    ...
    <div class="grid grid-cols-3 gap-3 items-start py-2 border-b">
        ...
        <div>
            <div class="w-full border rounded p-2 bg-gray-100 text-gray-800">
                R <?php echo e(number_format((float)($w->avg_sale_price_admin ?? $w->avg_sale_price ?? 1060000), 2)); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <div class="w-full border rounded p-2 bg-blue-50 text-gray-900">
                R <?php echo e(number_format((float)($dealStats['avg_sale_price_inc_vat'] ?? 0), 2)); ?>
            ...
            <div class="w-full border rounded p-2 bg-blue-50 text-gray-900 mt-2">
                ...
                <?php echo e($fmtR($all['avg_sale_price_inc_vat'] ?? 0)); ?>

                <div class="text-xs text-gray-600 mt-1"><b>Ex VAT:</b> <?php echo e($fmtR($all['avg_sale_price_ex_vat'] ?? 0)); ?></div>
                <div class="text-xs text-gray-600 mt-1">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <div class="w-full border rounded p-2 bg-blue-50 text-gray-900">
                <?php echo e(number_format((float)($dealStats['effective_commission_percent_ex_vat'] ?? 0), 2)); ?>%
                <div class="text-xs text-gray-600 mt-1">
            ...
            <div class="w-full border rounded p-2 bg-blue-50 text-gray-900 mt-2">
                <div class="text-xs text-gray-600 mb-1"><b>All-time</b></div>
                <?php echo e($fmtPct($all['effective_commission_percent_ex_vat'] ?? 0)); ?>
...
<h2 class="text-lg font-semibold mb-3">Target Requirements (Plan vs Market Reality)</h2>
        ...
        <?php else: ?>
            <?php
                ...
                $cp = (float)($w->correctly_priced_percent ?? 0);
                $cpFactor = ($cp / 100.0);
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div class="border rounded p-4 bg-white">
                      ...
                      <div class="grid grid-cols-1 gap-2 text-sm">
                          <div><b>Period:</b> <?php echo e($w->period); ?></div>

                          <div class="mt-2"><b>Nett Take-home at Company Budget:</b> R <?php echo e(number_format($plannedBudgetUsed, 2)); ?></div>
                          ...
                          <div class="mt-2"><b>Gross Commission Needed (Ex VAT):</b> R <?php echo e(number_format($plannedTotalCommissionNeededEx, 2)); ?></div>
                          <div><b>Sales Value Needed:</b> R <?php echo e(number_format($plannedSalesValueNeededInc, 2)); ?> <span class="text-xs text-gray-500">(Inc VAT)</span></div>
                          <div class="text-xs text-gray-500">Ex VAT: R <?php echo e(number_format($plannedSalesValueNeededEx, 2)); ?> • Comm% used: <?php echo e(number_format($planCommissionPercent, 2)); ?>%</div>

                          <div class="text-xs text-gray-500">
                              Uses your budget unless the company-floor requires more.
                          </div>

                          <div class="mt-2"><b>Sales Needed / Month:</b> <?php echo e(number_format($plannedSalesNeeded, 2)); ?></div>
                          <div><b>Total Listings Needed:</b> <?php echo e(number_format($plannedListingsNeeded, 2)); ?></div>
                          <div><b>Gap (Needed - Current):</b> <?php echo e(number_format($plannedGap, 2)); ?></div>
                  ...
                  <div class="border rounded p-4 bg-white">
                      ...
                      <div class="grid grid-cols-1 gap-2 text-sm">
                          <div><b>Period:</b> <?php echo e($dealStats['period'] ?? $w->period); ?></div>

                          <div class="mt-2"><b>Nett Take-home at Company Budget:</b> R <?php echo e(number_format($actualBudgetUsed, 2)); ?></div>
                          ...
                          <div class="mt-2"><b>Gross Commission Needed (Ex VAT):</b> R <?php echo e(number_format($actualTotalCommissionNeededEx, 2)); ?></div>
                          <div><b>Sales Value Needed:</b> R <?php echo e(number_format($actualSalesValueNeededInc, 2)); ?> <span class="text-xs text-gray-500">(Inc VAT)</span></div>
                          <div class="text-xs text-gray-500">Ex VAT: R <?php echo e(number_format($actualSalesValueNeededEx, 2)); ?> • Comm% used: <?php echo e(number_format($marketCommissionPercentEx, 2)); ?>%</div>

                          <div class="text-xs text-gray-500">
                              Same budget logic, but per-sale performance comes from Deal Register averages.
                          </div>

                          <div class="mt-2"><b>Sales Needed / Month:</b> <?php echo e(number_format($actualSalesNeeded, 2)); ?></div>
                          <div><b>Total Listings Needed:</b> <?php echo e(number_format($actualListingsNeeded, 2)); ?></div>
                          <div><b>Gap (Needed - Current):</b> <?php echo e(number_format($actualGap, 2)); ?></div>
                  ...
                  <div class="border rounded p-4 bg-yellow-50">
                      ...
                      <div class="grid grid-cols-1 gap-2 text-sm">
                          <div><b>Period:</b> <?php echo e($dealStats['period'] ?? $w->period); ?></div>
                            <div><b>Nett Take-home at Company Budget:</b> R <?php echo e(number_format($deltaBudgetUsed, 2)); ?></div>
                          <div class="mt-2"><b>Commission / Sale (Ex VAT):</b> R <?php echo e(number_format($delta_comm_per_sale, 2)); ?></div>
                          <div><b>Your Net / Sale (Ex VAT):</b> R <?php echo e(number_format($delta_net_per_sale, 2)); ?></div>

                          <div class="mt-2"><b>Sales Needed / Month:</b> <?php echo e(number_format($deltaSalesNeeded, 2)); ?></div>
                          <div><b>Total Listings Needed:</b> <?php echo e(number_format($deltaListingsNeed, 2)); ?></div>
                          <div><b>Gap (Needed - Current):</b> <?php echo e(number_format($deltaGap, 2)); ?></div>
                      </div>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $worksheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="border-b">
                                <td class="p-2"><?php echo e($row->period); ?></td>
                                <td class="p-2">R <?php echo e(number_format($c['net_need'], 2)); ?></td>
                                <td class="p-2"><?php echo e($row->current_listings); ?></td>
                                <td class="p-2"><?php echo e(number_format($row->correctly_priced_percent, 2)); ?>%</td>
                                <td class="p-2"><?php echo e($row->updated_at->format('Y-m-d H:i')); ?></td>
                            </tr>
...
<?php endif; ?><?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/worksheet/index.blade.php ENDPATH**/ ?>