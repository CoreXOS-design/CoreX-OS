...
<div class="nexus-sidebar">
    ...
    <nav class="flex-1 py-2 overflow-y-auto min-h-0">
        ...
        <a href="<?php echo e(route('nexus.dashboard')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'dashboard' ? 'active' : ''); ?>">
        ...
        <?php if(!$user || $user->canAccessNexusSection('documents')): ?>
        <a href="<?php echo e(route('nexus.documents')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'documents' ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if(!$user || $user->canAccessNexusSection('compliance')): ?>
        <a href="<?php echo e(route('nexus.compliance')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'compliance' ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if(!$user || $user->canAccessNexusSection('supervision')): ?>
        <a href="<?php echo e(route('nexus.supervision')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'supervision' ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if(!$user || $user->canAccessNexusSection('training')): ?>
        <a href="<?php echo e(route('nexus.training')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'training' ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if(!$user || $user->canAccessNexusSection('communication')): ?>
        <a href="<?php echo e(route('nexus.communication')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'communication' ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if(!$user || $user->canAccessNexusSection('client-portal')): ?>
        <a href="<?php echo e(route('nexus.client-portal')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'client-portal' ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if(\Illuminate\Support\Facades\Route::has('docuperfect.dashboard')): ?>
        <?php $dpExpanded = ($nexusSection === 'docuperfect'); ?>
        <div x-data="{ dpOpen: <?php echo e($dpExpanded ? 'true' : 'false'); ?> }">
            <button type="button" @click="dpOpen = !dpOpen" class="nexus-nav-item nexus-nav-group-toggle <?php echo e($dpExpanded ? 'active' : ''); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if(!$user || $user->canAccessNexusSection('franchise-admin')): ?>
        <a href="<?php echo e(route('nexus.franchise-admin')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'franchise-admin' ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div x-data="{ atOpen: <?php echo e($atExpanded ? 'true' : 'false'); ?> }">
            ...
            <div x-show="atOpen" <?php if (! ($atExpanded)): ?> x-cloak <?php endif; ?> x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="nexus-nav-children">
                ...
                <a href="<?php echo e(route('filing-register.index')); ?>" class="nexus-nav-subitem <?php echo e(request()->routeIs('filing-register.*') ? 'active' : ''); ?>">Filing Register</a>
        ...
        <?php if(\Illuminate\Support\Facades\Route::has('tools.pdf_splitter.index')): ?>
        <a href="<?php echo e(route('tools.pdf_splitter.index')); ?>" class="nexus-nav-item <?php echo e(request()->is('tools/pdf-splitter*') ? 'active' : ''); ?>">
        ...
        <?php if(config('features.presentations') && \Illuminate\Support\Facades\Route::has('presentations.index')): ?>
        <a href="<?php echo e(route('presentations.index')); ?>" class="nexus-nav-item <?php echo e(request()->is('presentations*') ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo e(route('documents.library.index')); ?>" class="nexus-nav-item <?php echo e(request()->is('documents/library*') ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<div class="nexus-nav-divider"></div>
        ...
        <?php if(!$user || $user->canAccessNexusSection('role-manager')): ?>
        <a href="<?php echo e(route('nexus.role-manager')); ?>" class="nexus-nav-item <?php echo e($nexusSection === 'role-manager' ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
            </svg>
...
<?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/layouts/nexus-sidebar.blade.php ENDPATH**/ ?>