...
return new class extends Migration
{
    ...
    {
        Schema::create('presentation_active_listings', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('presentation_id');
            $table->unsignedBigInteger('source_upload_id')->nullable();
            $table->date('listing_date')->nullable();
            $table->unsignedBigInteger('list_price_inc')->nullable();
    ...
    {
        Schema::dropIfExists('presentation_active_listings');
    }
};
