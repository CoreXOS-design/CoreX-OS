...
CREATE TABLE `prospecting_listings` (
  ...
  `portal_url` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `seller_outreach_sends` (
  ...
  `outcome` enum('sent','clicked','replied','booked','no_response','not_interested','bounced') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sent',
