...
CREATE TABLE `agency_features` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `agency_features_agency_id_feature_key_deleted_at_unique` (`agency_id`,`feature_key`,`deleted_at`),
  KEY `agency_features_updated_by_foreign` (`updated_by`),
  KEY `agency_features_agency_id_index` (`agency_id`),
...
CREATE TABLE `filing_link_review_queue` (
  ...
  `matched_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `match_status` enum('pending','resolved_linked','resolved_unlinked','resolved_skip') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `matched_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `candidates_json` json NOT NULL,
  `chosen_property_id` bigint unsigned DEFAULT NULL,
  `reviewed_at` timestamp NULL DEFAULT NULL,
  `reviewed_by_user_id` bigint unsigned DEFAULT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (1010,'2026_07_18_000001_create_agency_features_table',180);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (1011,'2026_07_18_000002_backfill_agency_features',180);
