...
CREATE TABLE `deal_v2_contacts` (
  ...
  `deal_id` bigint unsigned NOT NULL,
  `contact_id` bigint unsigned NOT NULL,
  `role` enum('buyer','seller','co_buyer','co_seller','conveyancer','bond_originator','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `deals_v2` (
  ...
  `deal_type` enum('bond','cash','sale_of_2nd') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('active','completed','cancelled','on_hold') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `property_id` bigint unsigned NOT NULL,
