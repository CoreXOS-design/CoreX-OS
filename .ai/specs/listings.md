...
- The card/table footer shows a **"Secondary"** badge (table: "2nd") on listings
  where the viewer is the secondary, so a co-listing is visually distinct from
  one they own. The primary agent's name is still shown.
